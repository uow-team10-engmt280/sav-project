...
# def publishing(): # Not sure what to do with these
#     broker = "192.168.1.10"
#     port = 1883
#     i = 0
...
# def otherPublish():
#     while True:
#         ret = client1.publish('MT280/Group10', string)
#         print(f'data sent {string}')
#         client.subscribe('MT280/Group10')
#         if prvmsg is not path:
    ...
    def createWindows(function): # Decorator - It creates the window with the controls and creates the sliding mask, this decorates the mainloop because these things will always need to exist
        def wrapper(): 
            ...
            try:
                ...
                image = rescaleFrame(cv.imread("C:/Users/LucaC/OneDrive/Documents/GitHub/sav-project/LucaCittadini/MachineVisionPictures/picCamTow (19).png"))
